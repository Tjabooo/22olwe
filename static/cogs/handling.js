...
export function updateAvailableTimes() {
    ...
    fetch('/platsbokning/update_times', {
        method: 'POST',
        headers: {
...
export function makeTicket() {
    ...
    fetch('/platsbokning/make_ticket', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
export function printTicket() {
    ...
    fetch('/platsbokning/print_ticket', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
export function cancelTicket() {
    ...
    fetch('/platsbokning/cancel_ticket', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
